...
The base image is provisioned with bash script [ubuntu-18.04-k3d.sh](https://github.com/elegoev/vagrant-ubuntu1804-k3d/blob/master/provisioning/ubuntu-18.04-k3d.sh)
